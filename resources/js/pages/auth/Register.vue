...
<template>
    <AuthBase title="Create an account" description="Create your organization and start managing competitions">
        <Head title="Register" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="name" type="text" required tabindex="2" autocomplete="name" v-model="form.name" placeholder="Full name" />
